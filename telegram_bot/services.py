...
class UserService:
    ...
    @staticmethod
    def set_language(db: Session, telegram_id: int, lang_code: str):
...
class OrderService:
    ...
    @staticmethod
    def create_order(db: Session, user: User, product: Product) -> Tuple[Optional[Order], str]:
        """
        Core Transaction:
        1. Checks balance.
    ...
    def get_user_statistics(db: Session, telegram_id: int, lang_code: str) -> str:
        ...
        # Calculate total spent (handle NULL if no orders)
...
class PaymentService:
    ...
    @staticmethod
    def create_topup_request(db: Session, telegram_id: int, method: str, txid_note: str) -> TopUp:
        """
...
class AdminService:
    ...
    @staticmethod
    def ban_user(db: Session, target_user_id: int, admin_id: int):
    ...
    @staticmethod
    def approve_topup(db: Session, topup_id: int, admin_id: int, actual_amount: float):
        """
